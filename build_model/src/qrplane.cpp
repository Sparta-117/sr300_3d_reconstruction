...
//        cout<<"CornerInCameraCor:"<<singleqrcorner->CornerInCameraCor[0]<<endl;
        cout<<"CornerInImage:"<<p1x<<","<<p1y<<"; ";
        cout<<"CornerInCamCor:"<<singleqrcorner->CornerInCameraCor[0]<<"; ";
        cout<<"Real depth:"<<singleqrcorner->CornerIndepthImage[0]<<";";
        cout<<"CornerInImage:"<<p2x<<","<<p2y<<"; ";
        cout<<"CornerInCamCor:"<<singleqrcorner->CornerInCameraCor[1]<<"; ";
        cout<<"Real depth:"<<singleqrcorner->CornerIndepthImage[1]<<";";
        cout<<"CornerInImage:"<<p3x<<","<<p3y<<"; ";
        cout<<"CornerInCamCor:"<<singleqrcorner->CornerInCameraCor[2]<<"; ";
        cout<<"Real depth:"<<singleqrcorner->CornerIndepthImage[2]<<";";
        cout<<"CornerInImage:"<<p4x<<","<<p4y<<"; ";
        cout<<"CornerInCamCor:"<<singleqrcorner->CornerInCameraCor[3]<<"; ";
        cout<<"Real depth:"<<singleqrcorner->CornerIndepthImage[3]<<endl;
...
void QRPlane::AllQRCornersInCamCor()
{
    ...
    for(int i=0;i<_qr.QRNumber;i++)
    {
        ...
        _AllQRCornersInWorldCor.push_back(cv::Point3f(-s + dx, s + dy, 0));
        _AllQRCornersInWorldCor.push_back(cv::Point3f(s + dx, s + dy, 0));
        _AllQRCornersInWorldCor.push_back(cv::Point3f(s + dx, -s + dy, 0));
        _AllQRCornersInWorldCor.push_back(cv::Point3f(-s + dx, -s + dy, 0));
